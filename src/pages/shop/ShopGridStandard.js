...
import {selectAllProduct,selectAllProductData} from '../../redux/products/product.selectors';
import {fetchProductsStart} from '../../redux/products/product.actions';

const ShopGridStandard = ({location, products,fetchProducts,isProducts}) => {
...
const mapStateToProps = state => {
    return{
        products: selectAllProductData(state),
        isProducts:selectAllProduct(state)
    }
}

...
const Privacy = ({ location }) => {
  ...
  return (
    <Fragment>
      <MetaTags>
        <title>Petrocart | Privacy-Policy</title>
        <meta
          name="description"
      ...
      <div className="container">
        <div className="welcome-content text-center">
          ...
          <p>
          &nbsp; &nbsp; &nbsp; The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to <strong>Petrocart</strong> and the terms "You" /"Your" / "Yourself" refer to the users.<br/>
          ...
          &nbsp; &nbsp; &nbsp; This Privacy Policy is a legally binding document between you and <strong>Petrocart</strong>. (both terms defined below). The terms of this Privacy Policy will be effective upon your acceptance of the same (directly or indirectly in electronic form, by clicking on the I accept tab or by use of the website or by other means) and will govern the relationship between you and <strong>Petrocart</strong> for your use of the website “Website” (defined below).
...
&nbsp; &nbsp; &nbsp;By providing us your Information or by making use of the facilities provided by the Website, You hereby consent to the collection, storage, processing and transfer of any or all of Your Personal Information and Non-Personal Information by us as specified under this Privacy Policy. You further agree that such collection, use, storage and transfer of Your Information shall not cause any loss or wrongful gain to you or any other person.<br/>
...
&nbsp; &nbsp; &nbsp;Our web servers automatically collect limited information about your computer's connection to the Internet, including your IP address, when you visit our site. (Your IP address is a number that lets computers attached to the Internet know where to send you data -- such as the web pages you view.) Your IP address does not identify you personally. We use this information to deliver our web pages to you upon request, to tailor our site to the interests of our users, to measure traffic within our site and let advertisers know the geographic locations from where our visitors come.<br/>
<strong>LINKS TO THE OTHER SITES</strong><br/>
&nbsp; &nbsp; &nbsp;Our policy discloses the privacy practices for our own web site only. Our site provides links to other websites also that are beyond our control. We shall in no way be responsible in way for your use of such sites.<br/>
...
&nbsp; &nbsp; &nbsp;Redressal Mechanism: Any complaints, abuse or concerns with regards to content and or comment or breach of these terms shall be immediately informed to the designated Grievance Officer as mentioned below via in writing or through email signed with the electronic signature to Pawan Bangar. ("Grievance Officer"). <br/>
<br/><br/>
&nbsp;&nbsp;Mr. Pawan Bangar. (Grievance Officer)<br/>
&nbsp;&nbsp;wwww.petrocart.in<br/>
&nbsp;&nbsp;Petrocart,Vijay Nagar chauwk,Aurangabad-431001<br/> 
&nbsp;&nbsp;Email:petrocartonline@gmail.com
&nbsp;&nbsp;Ph:7769891650

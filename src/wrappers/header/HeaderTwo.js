...
import PhoneNumber from "../../components/header/sub-components/PhoneNumber";
        ...
        <div className="header-top-area d-none d-lg-block">
          <div className="row">
            ...
            <div className="col-lg-2 d-none d-lg-block text-center">
              {/* header logo */}
              <Logo
                imageUrl="https://petrocart-92031.web.app/assets/img/logo/logo.png"
                logoClass="logo-hm-9"
              />
              <span logoClass='logo-hm-9'>Petrocart</span>
            </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-6 d-block d-lg-none">
              {/* header logo */}
              <Logo imageUrl="https://petrocart-92031.web.app/assets/img/logo/logo.png" logoClass="logo" />
             <span  className="logo-hm-9">Petrocart</span>
            </div>
            <div className="col-6 d-block d-lg-none">
              {/* Icon group */}
              <IconGroup />
